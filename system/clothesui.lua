...
for _, head in ipairs(clothes.heads_northhside) do
   ...
   local acquisitionData = translationstests[headData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, face in ipairs(clothes.faces_northhside) do
  local faceData = {
   ...
   local acquisitionData = translationstests[faceData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, feet in ipairs(clothes.feets_northhside) do
  local feetData = {
    ...
    local acquisitionData = translationstests[feetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, innertorso in ipairs(clothes.innertorsos_northhside) do
  local innertorsoData = {
    ...
    local acquisitionData = translationstests[innertorsoData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, legs in ipairs(clothes.legss_northhside) do
  local legsData = {
   ...
   local acquisitionData = translationstests[legsData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, outertorso in ipairs(clothes.outertorsos_northhside) do
  local outertorsoData = {
    ...
    local acquisitionData = translationstests[outertorsoData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, JohnnySilverhandset in ipairs(clothes.johnny_Silverhand_set) do
   ...
   local acquisitionData = translationstests[JohnnySilverhandsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, vcorposet in ipairs(clothes.v_corpo_set) do
    ...
    local acquisitionData = translationstests[vcorposetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, vnomadset in ipairs(clothes.v_nomad_set) do
   local vnomadsetData = {
    ...
    local acquisitionData = translationstests[vnomadsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, vstreetkidset in ipairs(clothes.v_streetkid_set) do
   local vstreetkidsetData = {
    ...
    local acquisitionData = translationstests[vstreetkidsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 for _, vTheRescueset in ipairs(clothes.v_The_Rescue_set) do
   local vTheRescuesetData = {
    ...
    local acquisitionData = translationstests[vTheRescuesetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local yorinubosetData = {
    ...
    local acquisitionData = translationstests[yorinubosetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local maxTacsetData = {
    ...
    local acquisitionData = translationstests[maxTacsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local nUSAgentsetData = {
   ...
   local acquisitionData = translationstests[nUSAgentsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local theStarsetData = {
    ...
    local acquisitionData = translationstests[theStarsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local thesunsetData = {
    ...
    local acquisitionData = translationstests[thesunsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local temperancesetData = {
    ...
    local acquisitionData = translationstests[temperancesetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local copsetData = {
    ...
    local acquisitionData = translationstests[copsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local corporatesetData = {
    ...
    local acquisitionData = translationstests[corporatesetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local fixersetData = {
    ...
    local acquisitionData = translationstests[fixersetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local mediasetData = {
    ...
    local acquisitionData = translationstests[mediasetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local netrunnersetData = {
    ...
    local acquisitionData = translationstests[netrunnersetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local nomadsetData = {
    ...
    local acquisitionData = translationstests[nomadsetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local rockersetData = {
    ...
    local acquisitionData = translationstests[rockersetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local solosetData = {
    ...
    local acquisitionData = translationstests[solosetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
 ...
 local techiesetData = {
    ...
    local acquisitionData = translationstests[techiesetData.acquisitionID] or { en = "Unknown", fr = "Unknown" }
  ...
  if ImGui.CollapsingHeader(string.format("Wattson (%d/%d)",Clothesui.ownedTotalwattson or 0, Clothesui.totalTotalwattson or 0)) then
    ...
    if ImGui.CollapsingHeader(string.format("northside (%d/%d)",Clothesui.ownedTotalnorthside or 0, Clothesui.totalTotalnorthside or 0)) then
      ...
      if ImGui.Button(string.format(T("ATT_HEAD") .."(%d/%d)",Clothesui.ownedTotalHeads_northhside or 0, Clothesui.totalHeads_northhside or 0), -1, 0) then
        ...
        setCategory(Clothesui, T("ATT_HEAD"))
      end
      if ImGui.Button(string.format(T("ATT_FEET") .." (%d/%d)",Clothesui.ownedTotalFeets_northhside or 0, Clothesui.totalFeets_northhside or 0), -1, 0) then
        ...
        setCategory(Clothesui, T("ATT_FEET"))
      end
      if ImGui.Button(string.format(T("ATT_FACE") .." (%d/%d)",Clothesui.ownedTotalFaces_northhside or 0, Clothesui.totalFaces_northhside or 0), -1, 0) then
              ...
              setCategory(Clothesui, T("ATT_FACE"))
      end
      if ImGui.Button(string.format(T("ATT_INNERTORSOS") .." (%d/%d)",Clothesui.ownedTotalInnerTorsos_northhside or 0, Clothesui.totalInnerTorsos_northhside or 0), -1, 0) then
              ...
              setCategory(Clothesui, T("ATT_INNERTORSOS"))
      end
      if ImGui.Button(string.format(T("ATT_OUTERTORSOS") .." (%d/%d)",Clothesui.ownedTotalOuterTorsos_northhside or 0, Clothesui.totalOuterTorsos_northhside or 0), -1, 0) then
              ...
              setCategory(Clothesui, T("ATT_OUTERTORSOS"))
      end
      if ImGui.Button(string.format(T("ATT_LEGS") .." (%d/%d)",Clothesui.ownedTotalLegss_northhside or 0, Clothesui.totalLegss_northhside or 0), -1, 0) then
              ...
              setCategory(Clothesui, T("ATT_LEGS"))
      end
      ImGui.Unindent(20)
    end
