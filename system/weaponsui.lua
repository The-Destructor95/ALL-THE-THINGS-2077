...
local translationstests     = _trad.descriptions
...
for _, handgun in ipairs(weapons.handguns) do 
    ...
    local acquisitionData = translationstests[handgunData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[handgunData.vendorID] or { en = "", fr = "" }
  ...
  for _, handgun_liberty in ipairs(weapons.handguns_liberty) do 
    ...
    local acquisitionData = translationstests[handgunData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[handgunData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, handgun_quest_liberty in ipairs(weapons.handguns_quest_liberty) do 
    ...
    local acquisitionData = translationstests[handgunData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[handgunData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, handgun_quest in ipairs(weapons.handguns_quest) do 
    ...
    local acquisitionData = translationstests[handgunData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[handgunData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, revolver in ipairs(weapons.revolvers) do 
    ...
    local acquisitionData = translationstests[revolverData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[revolverData.vendorID] or { en = "", fr = "" }
  ...
  for _, revolver_liberty in ipairs(weapons.revolvers_liberty) do 
    ...
    local acquisitionData = translationstests[revolverData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[revolverData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, revolver_quest_liberty in ipairs(weapons.revolvers_quest_liberty) do 
      ...
      local acquisitionData = translationstests[revolverData_quest_liberty.acquisitionID] or { en = "", fr = "" }
      local vendorData = translationstests[revolverData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, revolver_quest in ipairs(weapons.revolvers_quest) do 
      ...
      local acquisitionData = translationstests[revolverData_quest.acquisitionID] or { en = "", fr = "" }
      local vendorData = translationstests[revolverData_quest.vendorID] or { en = "", fr = "" }
...
--     local acquisitionData = translationstests[assault_rifleData.acquisitionID] or { en = "", fr = "" }
--     local vendorData = translationstests[assault_rifleData.vendorID] or { en = "", fr = "" }
...
--         local rarityData = translationstests[assault_rifleData.rarity] or { en = "", fr = "" }
...
--
  for _, assault_rifle_liberty in ipairs(weapons.assault_rifles_liberty) do 
      ...
      local acquisitionData = translationstests[assault_rifleData_liberty.acquisitionID] or { en = "", fr = "" }
      local vendorData = translationstests[assault_rifleData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, assault_rifle_quest_liberty in ipairs(weapons.assault_rifles_quest_liberty) do 
      ...
      local acquisitionData = translationstests[assault_rifleData_quest_liberty.acquisitionID] or { en = "", fr = "" }
      local vendorData = translationstests[assault_rifleData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, assault_rifle_quest in ipairs(weapons.assault_rifles_quest) do 
      ...
      local acquisitionData = translationstests[assault_rifleData_quest.acquisitionID] or { en = "", fr = "" }
      local vendorData = translationstests[assault_rifleData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, precision_rifle in ipairs(weapons.precision_rifles) do 
    ...
    local acquisitionData = translationstests[precision_rifleData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[precision_rifleData.vendorID] or { en = "", fr = "" }
  ...
  for _, precision_rifle_liberty in ipairs(weapons.precision_rifles_liberty) do 
    ...
    local acquisitionData = translationstests[precision_rifleData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[precision_rifleData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, precision_rifle_quest in ipairs(weapons.precision_rifles_quest) do 
    ...
    local acquisitionData = translationstests[precision_rifleData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[precision_rifleData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, sniper_rifle in ipairs(weapons.sniper_rifles) do 
    ...
    local acquisitionData = translationstests[sniper_rifleData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[sniper_rifleData.vendorID] or { en = "", fr = "" }
  ...
  for _, sniper_rifle_liberty in ipairs(weapons.sniper_rifles_liberty) do 
    ...
    local acquisitionData = translationstests[sniper_rifleData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[sniper_rifleData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, sniper_rifle_quest_liberty in ipairs(weapons.sniper_rifles_quest_liberty) do 
    ...
    local acquisitionData = translationstests[sniper_rifleData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[sniper_rifleData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, sniper_rifle_quest in ipairs(weapons.sniper_rifles_quest) do 
    ...
    local acquisitionData = translationstests[sniper_rifleData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[sniper_rifleData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, shotgun in ipairs(weapons.shotguns) do 
    ...
    local acquisitionData = translationstests[shotgunData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[shotgunData.vendorID] or { en = "", fr = "" }
  ...
  for _, shotgun_liberty in ipairs(weapons.shotguns_liberty) do 
    ...
    local acquisitionData = translationstests[shotgunData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[shotgunData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, shotgun_quest_liberty in ipairs(weapons.shotguns_quest_liberty) do 
    ...
    local acquisitionData = translationstests[shotgunData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[shotgunData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, shotgun_quest in ipairs(weapons.shotguns_quest) do 
    ...
    local acquisitionData = translationstests[shotgunData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[shotgunData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, smg in ipairs(weapons.smgs) do 
    ...
    local acquisitionData = translationstests[smgData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[smgData.vendorID] or { en = "", fr = "" }
  ...
  for _, smg_liberty in ipairs(weapons.smgs_liberty) do 
    ...
    local acquisitionData = translationstests[smgData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[smgData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, smg_quest_liberty in ipairs(weapons.smgs_quest_liberty) do 
    ...
    local acquisitionData = translationstests[smgData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[smgData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, smg_quest in ipairs(weapons.smgs_quest) do 
    ...
    local acquisitionData = translationstests[smgData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[smgData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, hmg in ipairs(weapons.hmgs) do 
    ...
    local acquisitionData = translationstests[hmgData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[hmgData.vendorID] or { en = "", fr = "" }
  ...
  for _, hmg_liberty in ipairs(weapons.hmgs_liberty) do 
    ...
    local acquisitionData = translationstests[hmgData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[hmgData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, hmg_quest_liberty in ipairs(weapons.hmgs_quest_liberty) do 
    ...
    local acquisitionData = translationstests[hmgData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[hmgData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, grenade in ipairs(weapons.grenades) do 
    ...
    local acquisitionData = translationstests[grenadeData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[grenadeData.vendorID] or { en = "", fr = "" }
  ...
  for _, grenade_quest in ipairs(weapons.grenades_quest) do 
    ...
    local acquisitionData = translationstests[grenadeData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[grenadeData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, axe in ipairs(weapons.axes) do 
    ...
    local acquisitionData = translationstests[axeData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[axeData.vendorID] or { en = "", fr = "" }
  ...
  for _, axe_liberty in ipairs(weapons.axes_liberty) do 
    ...
    local acquisitionData = translationstests[axeData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[axeData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, axe_quest_liberty in ipairs(weapons.axes_quest_liberty) do 
    ...
    local acquisitionData = translationstests[axeData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[axeData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, chainsword in ipairs(weapons.chainswords) do 
    ...
    local acquisitionData = translationstests[chainswordData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[chainswordData.vendorID] or { en = "", fr = "" }
  ...
  for _, chainsword_liberty in ipairs(weapons.chainswords_liberty) do 
    ...
    local acquisitionData = translationstests[chainswordData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[chainswordData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, katana in ipairs(weapons.katanas) do 
    ...
    local acquisitionData = translationstests[katanaData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[katanaData.vendorID] or { en = "", fr = "" }
  ...
  for _, katana_quest in ipairs(weapons.katanas_quest) do 
    ...
    local acquisitionData = translationstests[katanaData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[katanaData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, knive in ipairs(weapons.knives) do 
    ...
    local acquisitionData = translationstests[kniveData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[kniveData.vendorID] or { en = "", fr = "" }
  ...
  for _, knive_quest_liberty in ipairs(weapons.knives_quest_liberty) do 
    ...
    local acquisitionData = translationstests[kniveData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[kniveData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, knive_quest in ipairs(weapons.knives_quest) do 
    ...
    local acquisitionData = translationstests[kniveData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[kniveData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, machete in ipairs(weapons.machetes) do 
    ...
    local acquisitionData = translationstests[macheteData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[macheteData.vendorID] or { en = "", fr = "" }
  ...
  for _, machete_liberty in ipairs(weapons.machetes_liberty) do 
    ...
    local acquisitionData = translationstests[macheteData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[macheteData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, machete_quest_liberty in ipairs(weapons.machetes_quest_liberty) do 
    ...
    local acquisitionData = translationstests[macheteData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[macheteData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, sword in ipairs(weapons.swords) do 
    ...
    local acquisitionData = translationstests[swordData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[swordData.vendorID] or { en = "", fr = "" }
  ...
  for _, hammer in ipairs(weapons.hammers) do 
    ...
    local acquisitionData = translationstests[hammerData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[hammerData.vendorID] or { en = "", fr = "" }
  ...
  for _, hammer_quest in ipairs(weapons.hammers_quest) do 
    ...
    local acquisitionData = translationstests[hammerData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[hammerData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, onehandedclub in ipairs(weapons.one_handed_clubs) do 
    ...
    local acquisitionData = translationstests[onehandedclubData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[onehandedclubData.vendorID] or { en = "", fr = "" }
  ...
  for _, onehandedclub_quest_liberty in ipairs(weapons.one_handed_clubs_quest_liberty) do 
    ...
    local acquisitionData = translationstests[onehandedclubData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[onehandedclubData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, onehandedclub_quest in ipairs(weapons.one_handed_clubs_quest) do 
    ...
    local acquisitionData = translationstests[onehandedclubData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[onehandedclubData_quest.vendorID] or { en = "", fr = "" }
  ...
  for _, twohandedclub in ipairs(weapons.two_handed_clubs) do 
    ...
    local acquisitionData = translationstests[twohandedclubData.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[twohandedclubData.vendorID] or { en = "", fr = "" }
  ...
  for _, twohandedclub_liberty in ipairs(weapons.two_handed_clubs_liberty) do 
    ...
    local acquisitionData = translationstests[twohandedclubData_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[twohandedclubData_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, twohandedclub_quest_liberty in ipairs(weapons.two_handed_clubs_quest_liberty) do 
    ...
    local acquisitionData = translationstests[twohandedclubData_quest_liberty.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[twohandedclubData_quest_liberty.vendorID] or { en = "", fr = "" }
  ...
  for _, twohandedclub_quest in ipairs(weapons.two_handed_clubs_quest) do 
    ...
    local acquisitionData = translationstests[twohandedclubData_quest.acquisitionID] or { en = "", fr = "" }
    local vendorData = translationstests[twohandedclubData_quest.vendorID] or { en = "", fr = "" }
      ...
      if ImGui.CollapsingHeader(string.format(T("ATT_RANGED_WEAPONS") .."(%d/%d)",Weaponsui.ownedTotalRanged or 0, Weaponsui.totalTotalRanged or 0)) then
          ImGui.Indent(20)
            ...
            if ImGui.Button(string.format(T("ATT_PISTOLS") .."(%d/%d)",Weaponsui.ownedTotalHandguns or 0, Weaponsui.totalHandguns or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_PISTOLS"))
            end
            if ImGui.Button(string.format(T("ATT_REVOLVERS") .."(%d/%d)",Weaponsui.ownedTotalRevolvers or 0, Weaponsui.totalRevolvers or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_REVOLVERS"))
            ...
            if ImGui.Button(string.format(T("ATT_ASSAULT_RIFLES") .."(%d/%d)",Weaponsui.ownedTotalAssaultRifles or 0, Weaponsui.totalAssaultRifles or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_ASSAULT_RIFLES"))
            end
            if ImGui.Button(string.format(T("ATT_PRECISION_RIFLES") .."(%d/%d)",Weaponsui.ownedTotalPrecisionRifles or 0, Weaponsui.totalPrecisionRifles or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_PRECISION_RIFLES"))
            end
            if ImGui.Button(string.format(T("ATT_SNIPER_RIFLES") .."(%d/%d)",Weaponsui.ownedTotalSniperRifles or 0, Weaponsui.totalSniperRifles or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_SNIPER_RIFLES"))
            end
            if ImGui.Button(string.format(T("ATT_SHOTGUNS") .."(%d/%d)",Weaponsui.ownedTotalShotguns or 0, Weaponsui.totalShotguns or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_SHOTGUNS"))
            end
            if ImGui.Button(string.format(T("ATT_SMG") .."(%d/%d)",Weaponsui.ownedTotalSmgs or 0, Weaponsui.totalSmgs or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_SMG"))
            end
            if ImGui.Button(string.format(T("ATT_HMG") .."(%d/%d)",Weaponsui.ownedTotalHmgs or 0, Weaponsui.totalHmgs or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_HMG"))
            end
            if ImGui.Button(string.format(T("ATT_GRENADES") .."(%d/%d)",Weaponsui.ownedTotalGrenades or 0, Weaponsui.totalGrenades or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_GRENADES"))
            end
          ImGui.Unindent(20)
      end
    ...
    if ImGui.CollapsingHeader(string.format(T("ATT_MELEE_WEAPONS") .."(%d/%d)",Weaponsui.ownedTotalMelee or 0, Weaponsui.totalTotalMelee or 0)) then
        ImGui.Indent(20)
          if ImGui.Button(string.format(T("ATT_TWO_HANDLE") .."(%d/%d)",Weaponsui.ownedTotalTwoHandedClubs or 0, Weaponsui.totalTwoHandedClubs or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_TWO_HANDLE"))
          end
          if ImGui.Button(string.format(T("ATT_ONE_HANDLE") .."(%d/%d)",Weaponsui.ownedTotalOneHandedClubs or 0, Weaponsui.totalOneHandedClubs or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_ONE_HANDLE"))
          end
          if ImGui.Button(string.format(T("ATT_HAMMERS") .."(%d/%d)",Weaponsui.ownedTotalHammers or 0, Weaponsui.totalHammers or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_HAMMERS"))
          end
          if ImGui.Button(string.format(T("ATT_SWORDS") .."(%d/%d)",Weaponsui.ownedTotalSwords or 0, Weaponsui.totalSwords or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_SWORDS"))
          end
          if ImGui.Button(string.format(T("ATT_MACHETES") .."(%d/%d)",Weaponsui.ownedTotalMachetes or 0, Weaponsui.totalMachetes or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_MACHETES"))
          end
          if ImGui.Button(string.format(T("ATT_KNIVES") .."(%d/%d)",Weaponsui.ownedTotalKnives or 0, Weaponsui.totalKnives or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_KNIVES"))
          end
          if ImGui.Button(string.format(T("ATT_KATANAS") .."(%d/%d)",Weaponsui.ownedTotalKatanas or 0, Weaponsui.totalKatanas or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_KATANAS"))
          end
          if ImGui.Button(string.format(T("ATT_CHAINSWORDS") .."(%d/%d)",Weaponsui.ownedTotalChainswords or 0, Weaponsui.totalChainswords or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_CHAINSWORDS"))
          end
          if ImGui.Button(string.format(T("ATT_AXES") .."(%d/%d)",Weaponsui.ownedTotalAxes or 0, Weaponsui.totalAxes or 0), -1, 0) then
              ...
              setCategory(Weaponsui, T("ATT_AXES"))
          end
        ImGui.Unindent(20)
    end
    ImGui.Unindent(20)
